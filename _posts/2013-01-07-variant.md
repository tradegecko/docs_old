...
**composite**                  | Boolean       |                                                     
**sellable**                   | Boolean       |                                                     
**locations**                  | Array         | Variant stock levels in locations.     
**vendor_code**                | String        |                                                     
**image_ids**                  | Array         |                                                     
          ...
          "variants": [
              {
                  ...
                  locations: [
                    { location_id: 18, stock_on_hand: "9.0", committed_stock: "0"},
                    { location_id: 153, stock_on_hand: "24.0", committed_stock: "0"}
                  ]
                  vendor_code: "11111",
                  cost_price: "25.0",
